...
// Import from new field/datefield/popover files
        ...
        >
            ...
            <FieldGroup>
                ...
                <Button
                    variant="ghost"
                    size="icon"
                    className="mr-1 size-6 data-[focus-visible]:ring-offset-0 text-white/50"
                >
                    <CalendarIcon aria-hidden className="size-4" />
                </Button>
            </FieldGroup>
            {description && (
                <Text className="text-sm text-white/60" slot="description">
                    {description}
                </Text>
            )}
...
function JollyDateRangePicker<T extends AriaDateValue>({
    ...
    return (
        ...
        >
            <Label>{label}</Label>
            <FieldGroup>
                <DateInput variant="ghost" slot={"start"} className="text-white" />
                <span aria-hidden className="px-2 text-sm text-white/40">
                    -
                </span>
                <DateInput className="flex-1 text-white" variant="ghost" slot={"end"} />

                <Button
                    variant="ghost"
                    size="icon"
                    className="mr-1 size-6 data-[focus-visible]:ring-offset-0 text-white/50 group-data-[focus-within]:text-accent"
                >
                    <CalendarIcon aria-hidden className="size-4" />
                </Button>
            </FieldGroup>
